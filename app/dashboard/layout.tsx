            ...
            <div className="flex min-h-screen bg-background text-foreground font-sans selection:bg-primary-500/30">
                ...
                */}
                <div className="flex-1 md:ml-72 flex flex-col min-h-screen relative transition-all duration-300">
                    ...
                    {/* Soft Ambient Glow (Top Right) - Wrapped to prevent overflow */}
                    <div className="absolute inset-0 overflow-hidden pointer-events-none">
                        <div className="absolute top-0 right-[-10%] w-[800px] h-[600px] bg-[#1500FF]/5 rounded-full blur-[120px]" />
                        <div className="absolute top-[20%] left-[25%] w-[400px] h-[400px] bg-indigo-500/5 rounded-full blur-[100px]" />
                    </div>
